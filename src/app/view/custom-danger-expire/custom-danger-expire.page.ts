...
@Component({
  selector: 'cs-danger-expire',
  templateUrl: './custom-danger-expire.page.html',
  styleUrls: ['./custom-danger-expire.page.scss'],
})
export class CustomDangerExpire implements OnInit, OnChanges {
  ...
  */
  ...
  async getList(query: any) {
    ...
    await this.http.post('getAutoExpireTaskList', query).then((res: any) => {
      if (res.code === 200) {
