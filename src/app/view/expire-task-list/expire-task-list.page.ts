...
@Component({
  selector: 'ph-task-expire',
  templateUrl: './expire-task-list.page.html',
  styleUrls: ['./expire-task-list.page.scss'],
})
export class ExpireTaskListComponent implements OnInit, OnChanges {
  ...
  */
  ...
  async getList(query: any) {
    ...
    await this.http.post('getExpireTaskList', query).then((res: any) => {
      if (res.code === 200) {
