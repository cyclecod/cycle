...
@Component({
  selector: 'ph-danger-expire',
  templateUrl: './expire-danger-list.page.html',
  styleUrls: ['./expire-danger-list.page.scss'],
})
export class ExpireDangerListComponent implements OnInit, OnChanges {
  state = {
    refreshState: {
  ...
  async getList(query: any) {
    ...
    await this.http.post('getExpireDangerList', query).then(async (res: any) => {
      if (res.code === 200) {
